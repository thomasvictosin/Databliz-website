...
export default function HeroVisual() {
  ...
  return (
    ...
    >
      ...
      <div
        className="hv-hero-container absolute bottom-[-10%] -right-[6.5%] max-lg:bottom-auto max-lg:right-auto w-full max-w-[900px] md:max-w-[700px] max-md:max-w-none pointer-events-none z-20 mix-blend-lighten"
        ref={heroRef}
      >
        <img
          src={IMG.hero}
